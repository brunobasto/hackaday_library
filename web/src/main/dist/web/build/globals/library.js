...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_open('label', null, null, 'class', 'control-label', 'for', 'nome');
      itext('Nome');
      ie_close('label');
      ie_open('input', null, null, 'type', 'text', 'class', 'form-control', 'id', 'nome', 'placeholder', 'Nome', 'value', nome);
      ie_close('input');
      ie_close('div');
      ie_close('div');
      ie_close('div');
  ...
  var OrganizationForm = function (_Component) {
    babelHelpers.inherits(OrganizationForm, _Component);

    function OrganizationForm() {
      babelHelpers.classCallCheck(this, OrganizationForm);
      return babelHelpers.possibleConstructorReturn(this, _Component.apply(this, arguments));
    }
  ...
  this.LibraryNamed.OrganizationForm = this.LibraryNamed.OrganizationForm || {};
  this.LibraryNamed.OrganizationForm.OrganizationForm = OrganizationForm;
  this.LibraryNamed.OrganizationForm.templates = templates;
  this.Library.OrganizationForm = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
