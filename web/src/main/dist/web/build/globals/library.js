...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      if (textPrimary) {
        ie_open('h1', null, null, 'class', 'login-text-primary');
        textPrimary();
        ie_close('h1');
      }
      ...
      if (opt_data.social != null) {
        ...
        ie_open('button', null, null, 'class', 'btn btn-social btn-github', 'type', 'button', 'data-onclick', 'loginWithGithub');
        ie_open('span', null, null, 'class', 'brand');
        ie_void('span', null, null, 'class', 'icon icon-12-github');
        ie_close('span');
      ...
      if (opt_data.name != null) {
        ...
        itext('Name');
        ie_close('label');
        ie_open('input', null, null, 'type', 'name', 'class', 'form-control', 'name', 'name', 'value', ($$temp = opt_data.name) == null ? '' : $$temp, 'autofocus', '', 'required', '');
        ie_close('input');
        ie_close('div');
      }
      if (opt_data.email != null) {
        ...
        itext('Email');
        ie_close('label');
        ie_open('input', null, null, 'type', 'email', 'class', 'form-control', 'name', 'email', 'value', ($$temp = opt_data.email) == null ? '' : $$temp, 'autofocus', '', 'required', '');
        ie_close('input');
        ie_close('div');
      }
      if (opt_data.password != null) {
        ...
        itext('Password');
        ie_close('label');
        ie_open('input', null, null, 'type', 'password', 'class', 'form-control', 'name', 'password', 'value', ($$temp = opt_data.password) == null ? '' : $$temp, 'required', '');
        ie_close('input');
        ie_close('div');
      }
      ie_open('div', null, null, 'class', 'btn-container');
      ie_open('button', null, null, 'type', 'submit', 'class', 'btn btn-success', 'name', 'submit');
      itext((goog.asserts.assert(opt_data.textSubmit != null), opt_data.textSubmit));
      ie_close('button');
      ie_close('div');
      if (textSecondary) {
        ie_open('p', null, null, 'class', 'login-text-secondary');
        textSecondary();
        ie_close('p');
      }
      ie_close('div');
      if (textFooter) {
        ie_open('p', null, null, 'class', 'login-text-footer');
        textFooter();
        ie_close('p');
      }
    }
...
(function () {
	...
	var LoginForm = function (_Component) {
		...
		LoginForm.prototype.loginWithGithub = function loginWithGithub() {
...
(function () {
    ...
    goog.loadModule(function (exports) {
        ...
        function $render(opt_data, opt_ignored, opt_ijData) {
            ...
            ie_close('link');
            ie_open('link', null, null, 'rel', 'stylesheet', 'href', '/build/dashboard.css');
            ie_close('link');
            ie_close('head');
            ie_open('body');
            ...
            ie_void('script', null, null, 'src', '/build/globals/dashboard.js');
            ie_open('!--', null, null, 'Analytics', '', '--', '');
            itext('\n\t\t\t\t');
            ie_open('script');
